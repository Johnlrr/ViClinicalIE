...
def test_validator_detects_offset_mismatch(tmp_path) -> None:
    ...
    path.write_text('{"file_id":"x","text":"sốt","source":"x","confidence_tier":"TASK_ALIGNED_BY_CONSTRUCTION","generator_version":"1","seed":1,"entities":[{"text":"ho","start":0,"end":2,"type":"TRIỆU_CHỨNG","source":"x","metadata":{"template_family":"t","concept_family":"c","noise_profile":"clean"}}]}\n', encoding="utf-8")
